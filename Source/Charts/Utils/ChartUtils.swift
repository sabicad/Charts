...
open class ChartUtils
{
    ...
    internal class func draw(text: String, attributes: [NSAttributedStringKey : AnyObject]?, rect: CGRect, fonts: [UIFont]) {
        if text.contains("\n") {
    ...
    internal class func drawMultilineText(context: CGContext, text: String, knownTextSize: CGSize, point: CGPoint, attributes: [NSAttributedStringKey : AnyObject]?, constrainedToSize: CGSize, anchor: CGPoint, angleRadians: CGFloat, fonts:[UIFont])
    {
        var rect = CGRect(origin: CGPoint(), size: knownTextSize)
    ...
    internal class func drawMultilineText(context: CGContext, text: String, point: CGPoint, attributes: [NSAttributedStringKey : AnyObject]?, constrainedToSize: CGSize, anchor: CGPoint, angleRadians: CGFloat, fonts:[UIFont])
    {
        let rect = text.boundingRect(with: constrainedToSize, options: .usesLineFragmentOrigin, attributes: attributes, context: nil)
